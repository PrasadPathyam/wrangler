...
/*
  ...
  */
/**
 * Provides a way to access arguments passed to a directive. 
 * Implementations of this interface are used to retrieve values
 * by key, either as strings or converted into a specific type.
 */
public interface Arguments {
  ...
  /*
    ...
    * The <code>name</code> is expected to be the same as specified in the
    * <code>UsageDefinition</code>. There are two reasons why the
    * <code>name</code> might not exist in this object:
    *
    * <ul>
    *   <li>When a token is defined to be optional, the user might not have
    *   specified the token, hence the token would not exist in the argument.</li>
    *   <li>User has specified an invalid <code>name</code>.</li>
    * </ul>
    *
  ...
  /*
    ...
    * {@link TokenType}. When the directive is parsed into tokens,
    * the type of the token is passed through.
    *
    * @param name associated with the token.
  ...
  /*
    ...
    * by the user. It returns the <code>String</code> representation of the
    * directive.
    *
  ...
  /*
    ...
    *
    * @return an instance of <code>JsonElement</code> representing all the
